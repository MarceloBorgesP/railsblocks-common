...
require "railsblocks/common/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "railsblocks-common"
  s.version     = Railsblocks::Common::VERSION
  s.authors     = ["Celso Fernandes"]
  s.email       = ["fernandes@zertico.com"]
  s.homepage    = "http://domain.com"
  s.summary     = "Summary of Railsblocks::Common."
  s.description = "Description of Railsblocks::Common."
  s.license     = "MIT"
