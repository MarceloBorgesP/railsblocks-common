module Railsblocks::Common
  class Engine < ::Rails::Engine
    isolate_namespace Railsblocks::Common
    ...
    initializer "railsblocks-common.factories", :after => "factory_girl.set_factory_paths" do
      FactoryGirl.definition_file_paths << File.expand_path('../../../../spec/factories', __FILE__) if defined?(FactoryGirl)
    end


    # Initialize engine dependencies on wrapper application
    Gem.loaded_specs["railsblocks-common"].dependencies.each do |d|
      begin
        require d.name
      rescue LoadError => le
        # Put exceptions here.
